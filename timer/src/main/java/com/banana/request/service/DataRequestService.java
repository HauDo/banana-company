...
public class DataRequestService {
	...
	public static final String API_CHECK_STATUS_URL = "http://localhost:3000/api/employee/status";
	...
	public StatusDataResponse checkStatus() {
		...
		return response.readEntity(StatusDataResponse.class);
	}
	...
	private static Client createRestClient() {
		...
		clientConfig.register(new LoggingFeature(Logger.getLogger(LoggingFeature.DEFAULT_LOGGER_NAME), Level.INFO,
				LoggingFeature.Verbosity.PAYLOAD_ANY, 5000));
